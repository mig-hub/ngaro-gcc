...
/* What is Ngaro GCC ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   The purpose of this version of Ngaro is to take advantage of the GCC
   feature that allows you to use labels as values. It makes it less
   portable because it has to be compiled with the GCC compiler,
   but it has the advantage of being slightly closer to what one would do
   in an assembler version, and it is supposedly faster. That being said,
   this is just an experiment and I hope you'll like using it as much as
